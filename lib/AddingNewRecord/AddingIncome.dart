...
import 'package:smart_budget/AddingNewRecord/AddingExpense.dart';
...
class _AddingIncomeState extends State<AddingIncome> {
  ...
  static const String _type = 'Income';

  // Function to insert income record
  void _insertIncomeRecord() async {
                ...
                children: [
                  ...
                  TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      suffixIcon: IconButton(
                        icon: const Icon(Icons.money), // Icon for amount field
                        onPressed: () {},
                      ),
                      border: const OutlineInputBorder(),
                    ),
                  ...
                  TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText: "Enter Memo",
                      suffixIcon: IconButton(
                        icon: const Icon(Icons.comment), // Icon for memo field
                        onPressed: () {},
                      ),
                      border: const OutlineInputBorder(),
                    ),
